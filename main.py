...
# --- CUSTOM TAILWIND & FULL-SCREEN DARK THEME STYLING ---
...
def main_page():
    ...
    with ui.column().classes('w-full min-h-screen p-4 bg-[#031338]'):
        ...
        ticker_html = """
        <div style="width: 100%; overflow: hidden; white-space: nowrap; background-color: #1B2A4A; color: #FFFFFF; padding: 8px 0; font-weight: bold; font-size: 13px; margin-bottom: 15px; border-radius: 4px; border: 1px solid #FF8C00;">
            ...
            with ui.tab_panel(t_dash):
                ...
                def run_verification():
                    ...
                    try:
                        ...
                        REQUIREMENTS:
                        1. Use strictly METRIC (SI) plain text units (N/mm², MPa, kg/m³). DO NOT use LaTeX math strings, backslashes, or formulas with curly brackets. Write them out cleanly in readable plain text.
                        2. Provide clean Markdown Data Tables for each stage showing Specimen ID, Crushing Load, Deviation from Mean, and Individual Limit Check.
            ...
            with ui.tab_panel(t_audit):
                ...
                def run_ai_audit():
                    ...
                    try:
                        ...
                        Perform a comprehensive technical audit of the provided document or image. Structure your report using clear markdown sections and clean data tables in proper plain text without raw LaTeX, curly bracket errors, or formatting glitches.
                        """
                ...
                def send_chat():
                    ...
                    try:
                        system_prompt = (
                            ...
                            "recommendations strictly in the requested codes: ECP 203, ECP 202, ECP 104, ASTM, AASHTO, BS, EN, and ISO."
                            "\n2. UNIT SYSTEM: Use strictly METRIC (SI) units (mm, cm, m, MPa, kN, kg/m³, °C)."
                            "\n3. NO LATEX / NO RAW MATH BLOCKS: DO NOT use LaTeX double-dollar signs ($$), backslashes for math symbols, curly bracket variable leaks, or broken markdown formatting like four asterisks (****). Write formulas clearly in clean readable plain text."
                        )
                        ...
                        cleaned_response = clean_ai_text(res.text)
